...
connect(&_cameraSection,	&AgriSection::itemCountChanged,						this, &MissionSettingsItem::_setDirtyAndUpdateLastSequenceNumber);
connect(&_speedSection, 	&AgriSection::itemCountChanged,						this, &MissionSettingsItem::_setDirtyAndUpdateLastSequenceNumber);
connect(&_cameraSection,	&AgriSection::dirtyChanged,	this, &MissionSettingsItem::_sectionDirtyChanged);
connect(&_cameraSection,	&AgriSection::specifiedGimbalYawChanged,	this, &MissionSettingsItem::specifiedGimbalYawChanged);
